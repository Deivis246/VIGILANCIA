    ...
    rows: {
      ...
      items: {
        ...
        properties: {
          ...
          censusDate: { type: "STRING", nullable: true },
          confidence: { type: "STRING", enum: ["high", "medium", "low"] },
          warnings: { type: "ARRAY", items: { type: "STRING" } },
        },
        required: [
          "bedId", "occupied", "patientCode", "patientName", "age", "affiliation", "diagnosis", "stayDays", "urinaryCatheterDays",
          ...
          "rectalSwabPositiveDate", "censusDate",
          "confidence", "warnings",
        ],
      },
    },
